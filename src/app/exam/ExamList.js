      ...
      <div className="exam-list font-poppins">
        <ItemListPage title="Exam List"
          ...
          tableHeaders={[
            ...
            <TableCell key="exam-name">Exam Name</TableCell>,
          ...
          tableRowGenerator={{
            ...
            key: (exam) => exam.id,
            data: (exam) => [
              <TableCell key={exam?.id}>{exam?.id}</TableCell>,
              <TableCell key={exam?.name}>
                <Link to={`/exams/${exam.id}/problems`}>
                  {exam?.name}
                </Link>
              </TableCell>,
              <TableCell key={`${exam?.id}-start-time`}>{displayDate(exam?.startTime)}</TableCell>,
              <TableCell key={`${exam?.id}-end-time`}>{displayDate(exam?.endTime)}</TableCell>,
            ]
          }}/>
