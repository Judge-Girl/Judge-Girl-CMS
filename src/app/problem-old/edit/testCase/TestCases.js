            ...
            <div key={testCaseId}
                ...
                <div className="test-case-box-in columns">
                    ...
                    >
                        ...
                        <UploadFileButton
                            title={"Standard In +"} className={"test-case-upload-button"} buttonColor={"#F2B311"}
                        />
                    ...
                    >
                        ...
                        <UploadFileButton
                            title={"Standard In +"} className={"test-case-upload-button"} buttonColor={"#3EBDD9"}
                        />
