        ...
        contentRendering: () => (
            <form onSubmit={handleSubmit} ref={formRef}>
                <div id="modal" className="font-poppins has-text-centered">
                    ...
                    <ModalInput labelText="Name" value={name} required={true}
                                placeholder="Name"  placeholderTextAlign="left" fontSize="20px"
                                onChange={e => setName(e.target.value)}/>
                    <ModalInput type="email" labelText="Email" value={email} required={true}
                                placeholder="student@example.com"  placeholderTextAlign="left" fontSize="20px"
                                onChange={e => setEmail(e.target.value)}/>
                    <ModalInput type="password" labelText="Password" value={password} required={true}
